...
import api.endpoints.ClientEndPoints2;
import api.payloads.Employee;
import io.restassured.response.Response;

public class EmployeeTests2 {
	...
	{ 
		...
		Response res = ClientEndPoints2.createUser(emppayload);
	...
	public void testgetUser()
	{
		...
		Response res = ClientEndPoints2.retriveUser(this.emppayload.getId());
	...
	public void testPutUser()
	{
		...
		Response res = ClientEndPoints2.updateUser(emppayload, this.emppayload.getId());
		Assert.assertEquals(res.getStatusCode(), 200);
		System.out.println(res.getBody().asPrettyString());
	...
	public void testDeleteUser()
	{
		...
		Response res = ClientEndPoints2.deleteUser(this.emppayload.getId());
		Assert.assertEquals(res.getStatusCode(), 200);
		System.out.println(res.getBody().asPrettyString());
